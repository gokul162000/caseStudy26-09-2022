...
public class Applicant {
	...
	public String toString() {
		return String.format("%-5s %-10s %-5s %-5s %-5s %-10s %-10s",id, name, subject1Mark, subject2Mark, subject3Mark, total, percentage);
	}
	...
	public void setSubject2Mark(Double subjec2Mark) {
		this.subject2Mark = subjec2Mark;
	}
